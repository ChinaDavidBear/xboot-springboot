          ...
          <Row>
            <Form ref="searchForm" :model="searchForm" inline :label-width="70" class="search-form">
              <Form-item label="角色名称">
                <Input type="text" v-model="searchForm.name" clearable placeholder="请输入用户名" style="width: 200px"/>
              </Form-item>
      ...
      this.$refs.roleForm.validate(valid => {
        if (valid) {
          if (this.modalType === 0) {
            ...
            addRole(JSON.stringify(this.roleForm)).then(res => {
            ...
            this.submitLoading = true;
            editRole(JSON.stringify(this.roleForm)).then(res => {
              this.submitLoading = false;
              if (res.success === true) {
                this.$Message.success("操作成功");
                this.getRoleList();
